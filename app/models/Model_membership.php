...
class Model_membership extends CI_Model {
    ...
    function get_package_history($vendor_id = NULL, $package_id = NULL) {
        $this->db->select('app_package.*,app_membership_history.remaining_event,app_membership_history.status as membership_status,app_admin.first_name,app_admin.last_name');
