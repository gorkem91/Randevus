                ...
                <div class="col-md-5 m-auto">
                    <div class="header pt-3 bg-color-base">
                        <div class="d-flex px-3">
                            <h3 class="white-text mb-3 font-bold w-100 text-center"><?php echo translate('user_registration'); ?></h3>
                        </div>
                    </div>
                    <div class="card sm-mb-30">
                        <div class="card-body mt-4 resp_mx-0">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="first_name" name="first_name" class="form-control" placeholder="<?php echo translate('first_name'); ?>">                                        
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="last_name" name="last_name" class="form-control" placeholder="<?php echo translate('last_name'); ?>">                                        
                                <?php echo form_error('last_name'); ?>
                            </div>
                            <div class="error" id="last_name_validate"></div>
                            <div class="form-group">
                                <label for="email"> <?php echo translate('email'); ?> <small class="required">*</small></label>
                                <input type="email" id="email" name="email" class="form-control" placeholder="<?php echo translate('email'); ?>">                                        
                            ...
                            <div class="form-group">
                                <label for="password"> <?php echo translate('password'); ?> <small class="required mr-5px">*</small>
                                    <i class="fa fa-info-circle" tabindex="0" data-html="true" data-toggle="popover" title="<b>Password</b> - Rules" data-content='<span class="d-block"><b> <?php echo translate('info'); ?> - </b></span><span class="d-block">- <?php echo translate('password_length'); ?></span><span class="d-block">- <?php echo translate('password_lowercase'); ?></span><span class="d-block">- <?php echo translate('password_uppercase'); ?></span><span class="d-block">- <?php echo translate('password_numeric'); ?></span>'></i></label>
                            ...
                            <div class="form-group ">
                                <button type="submit" class="btn btn-outline-success waves-effect" style="margin-top: 25px;"> <?php echo translate('register'); ?> </button>
                            </div>
                            <?php echo form_close(); ?>
                        </div>
                        <!--/Form with header-->
...
<script src="<?php echo $this->config->item('admin_js_url'); ?>module/register.js" type="text/javascript"></script>
