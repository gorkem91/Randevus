                        ...
                        <div class="card mt-3">
                            ...
                            <div class="card-body mx-4 mt-4 resp_mx-0">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="email" id="email" name="email"  value='<?php if (!empty($enter_email)) echo $enter_email; ?>'  class="form-control" placeholder="<?php echo translate('email'); ?>">                                
                                ...
                                <div class="row d-flex align-items-center mb-4">
                                    ...
                                    <div class="col-md-7">
                                        <p class="font-small grey-text d-flex justify-content-end mt-3"><?php echo translate('return'); ?> <a href="<?php echo base_url("login"); ?>" class="dark-grey-text ml-1 font-bold"> <?php echo translate('login'); ?></a></p>
                                    </div>
                                </div>
                                <!--Grid row-->
                                <?php echo form_close(); ?>
