...
<html lang="en">
    <head>
        ...
        <link href="<?php echo $this->config->item('css_url'); ?>bookmyslot.css rel="stylesheet" type="text/css"/>
              <!-- Your custom styles -->   
                    ...
                    <div class="col-md-5 m-auto">
                        <a href="<?php echo base_url(); ?>">
                            <div class="text-center">
                                <?php
                                $global_logo = get_CompanyLogo();
                                if (file_exists(dirname(BASEPATH) . "/" . uploads_path . "/sitesetting/" . $global_logo) && $global_logo != '') {
                                    $global_logo_path = base_url() . uploads_path . '/sitesetting/' . $global_logo;
                                } else {
                                    $global_logo_path = base_url() . img_path . "/no-image.png";
                                }
                                ?>
                                <img id="imageurl"  class="img-responsive img-fluid"  style="" src="<?php echo $global_logo_path; ?>" alt="<?php echo translate('image'); ?>">
                            </div>
                        </a>
                        <!--Form with header-->
                        <div class="card mt-3">
                            ...
                            <div class="header p-4 bg-color-base">
                                <div class="row d-flex justify-content-center">
                                    <h3 class="mb-3 font-bold color-white" style="margin-bottom: 0 !important;"><?php echo translate('customer_login'); ?></h3>
                                </div>
                            </div>
                            <!--Header-->
                            <div class="card-body mt-4 resp_mx-0">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="email" id="username" name="username" placeholder="<?php echo translate('email'); ?>" value='<?php if (!empty($enter_email)) echo $enter_email; ?>' class="form-control">                                
                                ...
                                <div class="row d-flex align-items-center mb-4">
                                    <div class="col-md-1 col-md-5 d-flex align-items-start">
                                        <div class="text-center">
                                            <button type="submit" class="btn btn-grey btn-rounded z-depth-1a bg-color-base color-white" style="margin-top: 20px;"><?php echo translate('login'); ?></button>
                                        </div>
                                    </div>
                                    <div class="col-md-7">
                                        <p class="font-small grey-text d-flex justify-content-end"> <a href="<?php echo base_url("forgot-password"); ?>" class="dark-grey-text ml-1 font-bold"> <?php echo translate('forgot_password'); ?>?</a></p>                                   
                                    </div>
                                </div>
                                <!--Grid row-->
                                <div class="text-center">
                                    <p class="font-small grey-text"><?php echo translate('dont_have_account'); ?>? : <a href="<?php echo base_url("register"); ?>" class="dark-grey-text ml-1 font-bold"> <?php echo translate('create_account'); ?></a></p>
                                </div>
                                <?php echo form_close(); ?>
                            </div>
                        </div>
