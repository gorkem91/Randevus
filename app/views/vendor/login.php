                    ...
                    <div class="card mt-3">
                        ...
                        <div class="header p-4 bg-color-base">
                            <div class="row d-flex justify-content-center">
                                <h3 class="white-text mb-3 font-bold" style="margin-bottom: 0 !important;"><?php echo translate('vendor_login'); ?></h3>
                            </div>
                        </div>
                        <!--Header-->
                        <div class="card-body mx-4 mt-4 resp_mx-0">
                            ...
                            <div class="row d-flex align-items-center mb-4">
                                ...
                                <div class="col-md-7">
                                    <p class="font-small grey-text d-flex justify-content-end"> <a href="<?php echo base_url("vendor/forgot-password"); ?>" class="dark-grey-text ml-1 font-bold"><?php echo translate('forgot_password'); ?>?</a></p>
                                </div>
                            </div>
                            <!--Grid row-->
                            <?php echo form_close(); ?>
