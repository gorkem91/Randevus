...
<html>
    <head>
        ...
        <?php include VIEWPATH . 'vendor/css.php'; ?>
        ...
        <nav class="nav navbar py-3 white">
            <div class="container-fluid pr-0">
                ...
                <ul class="nav navbar-nav nav-flex-icons ml-auto sidbar_ulnav top_navbar">
                    ...
                    <li class="nav-item">
                        <a  href="<?php echo base_url('vendor/payout-request') ?>" class="<?php echo $wallet_active; ?>  nav-link waves-effect text-muted"><i class="fa fa-dollar"></i> <span class="clearfix d-none d-sm-inline-block"><?php echo translate('earnings'); ?> $<?php echo isset($my_wallet['total']) ? $my_wallet['total'] : 0 ?></span></a>
                    </li>
                    <li class="nav-item">
