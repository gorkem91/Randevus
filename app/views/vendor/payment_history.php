                ...
                <div class="row">
                    <div class="col-md-12 m-auto">
                        ...
                        <div class="header bg-color-base">
                            <div class="d-flex">
                                <span>
                                    <h3 class="white-text font-bold pt-3"><?php echo translate('appointment_payment_history') ?></h3>
                                </span>  
                            </div>
                        </div>
                        <div class="card">
                                            ...
                                            if (isset($payment_data) && count($payment_data) > 0) {
                                                foreach ($payment_data as $row) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-center">$<?php echo $row['vendor_price']; ?></td>
                                                        <td class="text-center">$<?php echo $row['admin_price']; ?></td>
                                                        <td class="text-center"><?php echo $row['payment_status']; ?></td>
                                                        <td class="text-center"><?php echo date("m/d/Y H:i A", strtotime($row['created_on'])); ?></td>
                                                        <td class="text-center">
                                                            <?php if ($row['payment_status'] == 'pending') { ?>
                                                                <a id="" data-toggle="modal" onclick='UpdatePaymentStatus(this)' data-target="#update_details" data-id="<?php echo (int) $row['id']; ?>" class="btn btn-amber" title="Post">PROCESS</a>
                                                                <?php
                                                            } else {
