...
<div class="dashboard-body">
    ...
    <div class="content">
        ...
        <div class="container-fluid">
            ...
            <h2 class="text-center font-bold"><strong><?php echo translate('site_setting'); ?></strong></h2>
            <div class="card">
                <div class="card-body">
                    <div class="steps-form-2">
                        <div class="steps-row-2 setup-panel-2 d-flex justify-content-between">
                            <div class="steps-step-2">
                                <a href="#step-4" type="button" class="btn btn-amber waves-effect ml-0" data-toggle="tooltip" data-placement="top" title="<?php echo translate('basic'); ?> <?php echo translate('information'); ?>">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <?php echo form_input(array('id' => 'company_name', 'class' => 'form-control validate', 'name' => 'company_name', 'value' => $company_name, 'required' => 'required', 'placeholder' => translate('site_name'))); ?>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <?php echo form_input(array('id' => 'company_email1', 'class' => 'form-control validate', 'name' => 'company_email1', 'value' => $company_email1, 'required' => 'required', 'type' => 'email', 'placeholder' => translate('site_email'))); ?>
                                        <?php echo form_error('company_email1'); ?> 
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <?php echo form_label(translate('site_phone') . '-1 :', 'company_phone1', array('class' => 'control-label')); ?>
                                        <?php echo form_input(array('id' => 'company_phone1', 'class' => 'form-control validate', 'name' => 'company_phone1', 'value' => $company_phone1, 'placeholder' => translate('site_phone'))); ?>
                                    </div>
                                </div>
                                <div class="col-md-6 ">
                                    <div class="form-group">
                                        <?php echo form_label(translate('site_phone') . '-2 : ', 'company_phone2', array('class' => 'control-label')); ?>
                                        <?php echo form_input(array('id' => 'company_phone2', 'class' => 'form-control', 'name' => 'company_phone2', 'value' => $company_phone2, 'placeholder' => translate('site_phone'))); ?>
                                        <?php echo form_error('company_phone2'); ?>
                                    </div>
                                </div>
                                <div class="col-md-6 ">
                                    <div class="form-group">
                                        <?php echo form_label(translate('address') . '-1 :', 'company_address1', array('class' => 'control-label')); ?>
                                ...
                                <div class="col-md-6 ">
                                    <div class="form-group">
                                        <?php echo form_label(translate('address') . '-2 : ', 'company_address2', array('class' => 'control-label')); ?>
                                        <?php echo form_textarea(array('id' => 'company_address2', 'class' => 'form-control', 'name' => 'company_address2', 'type' => 'text', 'rows' => 3, 'value' => $company_address2, 'placeholder' => translate('address'))); ?>
                                        <?php echo form_error('company_address2'); ?>
                                    </div>
                                </div> 
                                <div class="col-md-6 ">
                                    <div class="form-group">
                                        <p class="black-text"><?php echo translate('select'); ?> <?php echo translate('language'); ?><small class="required">*</small></p>
                                        <?php
                                        $options = array();
                                ...
                                <div class="col-md-6 ">
                                    <div class="form-group">
                                        <p class="black-text"><?php echo translate('select'); ?> <?php echo translate('time_zone'); ?></p>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <?php echo form_input(array('id' => 'fb_link', 'class' => 'form-control', 'name' => 'fb_link', 'value' => $fb_link, 'type' => 'url', 'placeholder' => translate('facebook') . ' ' . translate('link'))); ?>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <?php echo form_input(array('id' => 'google_link', 'class' => 'form-control', 'name' => 'google_link', 'value' => $google_link, 'type' => 'url', 'placeholder' => translate('google+') . ' ' . translate('link'))); ?>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <?php echo form_input(array('id' => 'twitter_link', 'class' => 'form-control', 'name' => 'twitter_link', 'value' => $twitter_link, 'type' => 'url', 'placeholder' => translate('twitter') . ' ' . translate('link'))); ?>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <?php echo form_input(array('id' => 'insta_link', 'class' => 'form-control', 'name' => 'insta_link', 'value' => $insta_link, 'type' => 'url', 'placeholder' => translate('instagram') . ' ' . translate('link'))); ?>
                                ...
                                <div class="col-md-6 ">
                                    <div class="form-group">
                                        ...
                                        <?php echo form_input(array('id' => 'linkdin_link', 'class' => 'form-control', 'name' => 'linkdin_link', 'value' => $linkdin_link, 'type' => 'url', 'placeholder' => translate('linkdin') . ' ' . translate('link'))); ?>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <img id="imageurl2"  class="img-fluid"  src="<?php echo $icon_image; ?>" alt="Image" height="100">
                                        </div>
                                        <div class="file-field">
                                            <div class="btn btn-primary btn-sm">
                                                <span><?php echo translate('select'); ?> <?php echo translate('image'); ?></span>
                                                <input onchange="readURLIcon(this)" id="imageurl2" <?php if ($icon_check == false) echo "required"; ?>  type="file" name="fevicon_icon" accept="image/x-ico,image/x-icon,image/vnd-microsoft.icon"/>
                                            </div>
                                            <div class="file-path-wrapper" >
