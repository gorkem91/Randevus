...
?>
<script src="<?php echo $this->config->item('admin_js_url'); ?>module/Chart.min.js" type='text/javascript'></script>
<style>
        ...
        <div class="container-fluid ">
            <section class="form-light px-2 sm-margin-b-20">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card p-4">
                            <form action="<?php echo base_url($folder_name . '/appointment-report'); ?>" method="post">
                                <div class="row">
                                            ...
                                            <select class="kb-select initialized" name="vendor_id">
                                                ...
                                                if (isset($vendor_list) && count($vendor_list) > 0) {
                                                    foreach ($vendor_list as $vendor_value) {
                                                        ?>
                                                        <option value="<?php echo $vendor_value['id']; ?>" <?php echo isset($vendor_id) && $vendor_id == $vendor_value['id'] ? 'selected' : ''; ?>><?php echo ucfirst($vendor_value['first_name']) . " " . ucfirst($vendor_value['last_name']); ?></option>
                                                        <?php
                                                    }
                                                }
                                                ?>
