                        ...
                        <div class="header pt-3 bg-color-base">
                            <div class="d-flex">
                                <h3 class="white-text mb-3 font-bold">
                                    <?php echo isset($id) && $id > 0 ? translate('update') : translate('add'); ?> <?php echo translate('coupon'); ?>
                                </h3>
                            </div>
                        </div>
                        ...
                        <div class="card">
                            <div class="card-body mx-4 mt-4 resp_mx-0">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" required="" id="title" name="title" value="<?php echo $title; ?>" class="form-control" placeholder="<?php echo translate('coupon_title'); ?>">                                    
                                    <?php echo form_error('title'); ?>
                                </div>

                                <div class="form-group">
                                    <label for="title"> <?php echo translate('expiry_date'); ?><small class="required">*</small></label>
                                    <input type="date" min="<?php echo date("m-d-Y") ?>" required="" id="valid_till" name="valid_till" value="<?php echo $valid_till; ?>" class="form-control" placeholder="<?php echo translate('expiry_date'); ?>">                                    
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" required="" id="code" name="code" value="<?php echo $code; ?>" class="form-control" placeholder="<?php echo translate('code'); ?>">                                    
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" required="" id="discount_value" name="discount_value" value="<?php echo $discount_value; ?>" class="form-control" placeholder="<?php echo translate('discount_value'); ?>">                                    
