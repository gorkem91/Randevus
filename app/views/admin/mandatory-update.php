                ...
                <div class="card-body">
                    ...
                    <?php if (isset($total_event_category) && $total_event_category == 0) { ?>
                        <div class="col-md-12 mt-40">
                            <h6 class="box-border"><?php echo translate('mandatory_category'); ?> <a href="<?php echo base_url('admin/add-category'); ?>" class="btn btn-sm blue-gradient font-bold pull-right mt-0"><?php echo translate('add'); ?></a></h6>
                        </div>
                    <?php } ?>
