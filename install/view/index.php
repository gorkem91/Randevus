...
<html lang="en">
    <head>
        ...
        <link href="../assets/css/bookmyslot.css" rel="stylesheet">
        ...
        <script src="../assets/js/bookmyslot.js"></script>
                        ...
                        <div class="row setup-content-2" id="step-2">
                            ...
                            <div class="section clearfix">
                                ...
                                <div class="form-group mt-3">
                                    ...
                                    <input type="text" required="required" value="" id="host"  name="host" class="form-control validate" />                                    
                                </div>
                                <div class="form-group">
                                    <label for="dbuser">Database User</label>
                                    <input type="text" required="required" value="" name="dbuser" class="form-control validate" autocomplete="off"/>                                    
                                </div>
                                <div class="form-group">
                                    <label for="dbpassword">Password</label>
                                    <input type="password"  value="" name="dbpassword" class="form-control" autocomplete="off"/>                                    
                                </div>
                                <div class="form-group">
                                    <label for="dbname">Database Name</label>
                                    <input type="text" required="required" value="" name="dbname" class="form-control validate"/>                                    
                                </div>
                            </div>
                            ...
                            <div class="section clearfix">
                                ...
                                <div class="form-group mt-3">
                                    ...
                                    <input type="text" required="required" value=""  id="first_name"  name="first_name" class="form-control validate" />                                    
                                </div>
                                <div class="form-group">
                                    <label for="last_name">Last Name</label>
                                    <input type="text" required="required"  value="" id="last_name"  name="last_name" class="form-control validate" />                                    
                                </div>
                                <div class="form-group">
                                    <label for="email">Email</label>
                                    <input type="email" required="required" value="" name="email" class="form-control validate"  />                                    
                                </div>
                                <div class="form-group">
                                    <label for="password">Password</label>
                                    <input type="password" required="required" value="" name="password" class="form-control validate" />                                    
                                </div>
                        ...
                        <div class="row setup-content-2" id="step-3">
                            ...
                            <div class="section clearfix">
                                ...
                                <div class="form-group mt-3">
                                    ...
                                    <input type="text" required="required" value="" id="sitename"  name="sitename" class="form-control validate" />                                    
                                </div>
                                <div class="form-group">
                                    <label for="siteemail">Site Email</label>
                                    <input type="email" required="required" value="" name="siteemail" class="form-control validate" autocomplete="off"/>                                    
                                </div>
                                <div class="form-group">
                        ...
                        <div class="row setup-content-2" id="step-4">
                            ...
                            <div class="section clearfix">
                                ...
                                <div class="form-group mt-3">
                                    ...
                                    <input type="text" required="required" value="" id="smtp_host"  name="smtp_host" class="form-control validate" />                                    
                                </div>
                                <div class="form-group">
                                    <label for="smtp_username">SMTP Username</label>
                                    <input type="text" required="required" value="" name="smtp_username" class="form-control validate"/>                                    
                                </div>
                                <div class="form-group">
                                    <label for="smtp_password">SMTP Password</label>
                                    <input type="password" required="required" value="" name="smtp_password" class="form-control validate" autocomplete="off"/>                                    
                                </div>
                                <div class="form-group">
                                    <label for="smtp_port">SMTP Port</label>
                                    <input type="number" required="required" value="" name="smtp_port" class="form-control validate"/>                                    
                                </div>
                                <div class="md-form">
